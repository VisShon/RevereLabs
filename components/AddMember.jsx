    ...
    <div className="absolute top-[-2rem] right-[-4rem] w-[50%] flex flex-col items-center">
        <Menu>
            ...
            <Menu.Items className="absolute top-[1.5rem] right-[5rem] w-[100%] flex flex-col items-center" >
                <input value={freeLancerEmail} onChange={(e)=>setFreeLancerEmail(e.target.value)} onKeyDown={onclickHandler} type="text" className="p-1 rounded-[5px] border-2 mt-2 w-[60%] z-[10]" placeholder="enter name"/>
