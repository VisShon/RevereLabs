    ...
    <>
...

      {
        ...
        (<div className="relative w-[12rem] h-[2.5rem] z-[10] mt-5">
            <a onClick={()=>setAddLink(prev=>!prev)} className="absolute right-2 z-20 top-2 cursor-pointer" >
                <Image src={'/vectors/cross.png'} height={15} width={15} />
            </a>
        ...
        (<div onClick={()=>setAddLink(preVal=>!preVal)} className="w-[12rem] cursor-pointer flex justify-center mt-5">
