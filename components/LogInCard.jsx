  ...
  return (
    <>
      <div className=" flex flex-col justify-evenly items-center w-[45rem] h-[30rem] bg-[#9DCEFB]  border-2 rounded-[5px] drop-shadow-[10px_10px_0px_rgba(0,0,0,1)]">
        ...
        (<a href="#" onClick={onclickHandler} className="w-[20rem] h-[5rem]  mt-20 flex justify-center items-center rounded-[8px] hover:drop-shadow-[5px_5px_0px_rgba(159,159,159,1)]" style={{backgroundColor:data.backgroundColor}}>
