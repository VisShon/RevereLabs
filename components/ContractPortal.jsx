...
function ContractPortal() {
    ...
    return (
        <div className=" bg-accent relative h-[30rem] w-[25rem] border-[0.5rem] border-[#B8DED3] rounded-md flex flex-col items-center justify-around ">
            <div onClick={()=>OnclickHandler('terms')}
                className="bg-accent cursor-pointer border-2 border-textMain text-main w-[100%] h-[7rem]  font-mada font-[700] text-center flex items-center justify-center"><h2>Terms</h2></div>
            {terms&&<div className=" h-[10rem] w-[100%]  p-2"><Terms/></div> }
            <div onClick={()=>OnclickHandler('checkpoints')}
                className="bg-accent cursor-pointer border-x-2 border-b-2 border-textMain text-main w-[100%] h-[7rem]  font-mada font-[700] text-center flex items-center justify-center"><h2>Checkpoints</h2></div>
            {checkpoint&&<div className=" h-[10rem] w-[100%]  p-2"><Checkpoints/></div>}
            <div onClick={()=>OnclickHandler('bounty')}
                className="bg-accent cursor-pointer border-x-2 border-b-2 border-textMain text-main w-[100%] h-[7rem]  font-mada font-[700] text-center flex items-center justify-center"><h2>Bounty</h2></div>
